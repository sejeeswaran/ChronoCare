...
Prerequisites
-------------
- ``models/hypertension_model.pkl`` must already exist on disk.
...
def predict_hypertension_risk(
    ...
    This function loads the pre-trained hypertension ML model
    (a Pipeline), validates input, and returns the
    ...
    - The preprocessing Pipeline inside the model handles scaling.
