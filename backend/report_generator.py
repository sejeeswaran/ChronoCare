...
def generate_report_pdf(
    ...
    high_risk = sum(1 for v in results.values() if isinstance(v, dict) and v.get("risk_level") == "High Risk")
    moderate = sum(1 for v in results.values() if isinstance(v, dict) and v.get("risk_level") == "Moderate Risk")
    ...
    pdf.cell(40, 6, f"High Risk: {high_risk}")
